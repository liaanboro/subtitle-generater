  ...
  return (
    <header className="h-20 border-b border-white/5 flex items-center justify-between px-10 relative z-10 bg-black/20 backdrop-blur-md">
      <div className="flex items-center">
        <div className="relative flex items-center justify-center w-8 h-8 rounded-full bg-green-500/10 mr-4">
          <div className="h-2.5 w-2.5 rounded-full bg-green-500 shadow-[0_0_12px_#22c55e]"></div>
